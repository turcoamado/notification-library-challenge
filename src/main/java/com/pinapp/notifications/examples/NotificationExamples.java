package com.pinapp.notifications.examples;

import com.pinapp.notifications.application.port.in.SendNotificationUseCase;
import com.pinapp.notifications.application.service.NotificationService;
import com.pinapp.notifications.infrastructure.sender.SenderFactory;
import com.pinapp.notifications.infrastructure.sender.email.SendGridEmailSenderMock;
import com.pinapp.notifications.infrastructure.sender.sms.TwilioSmsSenderMock;
import com.pinapp.notifications.infrastructure.sender.push.FcmPushSenderMock;
import com.pinapp.notifications.domain.model.Channel;
